                    ...
                    {filteredBlogs.map((blog) => (
                        ...
                        >
                            ...
                            <Link href={`/writer/blogs/${blog.slug.current}`}>
                                <button className="px-4 py-2 mt-auto rounded-md text-sm bg-transparent border border-[#733f01] font-medium shadow hover:bg-[#733f01] hover:text-white transition-all duration-300">
                                    Read More →
                                </button>
                            </Link>
                        </motion.div>

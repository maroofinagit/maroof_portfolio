...
const books: Book[] = [
    ...
    },
    {
        ...
        slug: "barkat",
        description:
            "Barkat is a softcover, 600-page love story set during the lockdown, blending Gen-Z reality with old-school romance, where a girl becomes a quiet blessing in a boy’s life, proving that even in isolation, love can arrive with patience, depth, and meaning.",
        longDescription:
